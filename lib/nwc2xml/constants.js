...
export const NWC_Version = {
  ...
  V170: 0x0146, V175: 0x014B, V200: 0x0200, V201: 0x0201, V205: 0x0205, V275: 0x024B
};
...
export const NoteAttr = {
  ...
  BeamBeg: 0x00100, BeamEnd: 0x00200, BeamMid: 0x00300, BeamMask: 0x00300,
  SlurBeg: 0x00400, SlurEnd: 0x00800, SlurMid: 0x00C00, SlurMask: 0x00C00,
  SlurDirUp: 0x01000, SlurDirDown: 0x02000, SlurDirMask: 0x03000,
  StemUp: 0x04000, StemDown: 0x08000, StemMask: 0x0C000,
  TieBeg: 0x10000, TieEnd: 0x20000,
  TieDirUp: 0x40000, TieDirDown: 0x80000, TieDirMask: 0xC0000
};
...
export function isValidVersion(v) {
  return [NWC_Version.V130, NWC_Version.V150, NWC_Version.V155, NWC_Version.V170, NWC_Version.V175, NWC_Version.V200, NWC_Version.V201, NWC_Version.V205, NWC_Version.V275].includes(v);
}
